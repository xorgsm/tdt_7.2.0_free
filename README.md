...
historial, grabación de stream, guía de programación (EPG) opcional y
ecualizador de audio.

Esta es la **versión free**, lista para usar desde el primer arranque.
...
y el icono — el EXE resultante funciona en PCs sin VLC instalado.
